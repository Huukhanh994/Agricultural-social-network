    ...
    <div class="messenger-listView">
        ...
        <div class="m-header">
            ...
            <div class="messenger-listView-tabs">
                <a href="#" @if($route == 'user') class="active-tab" @endif data-view="users">
                    <span class="fas fa-user"></span> People</a>
        ...
        <div class="m-body">
           ...
           <div class="@if($route == 'group') show @endif messenger-tab app-scroll" data-view="groups">
                ...
                {{-- Contact --}}
                <div class="listGroupContacts" style="width: 100%;height: calc(100% - 200px);"></div>
             </div>
        ...
        <div class="m-header m-header-messaging">
            <nav>
                ...
                <div style="display: inline-flex;">
                    ...
                    <div class="avatar av-s header-avatar" style="margin: 0px 10px; margin-top: -5px; margin-bottom: -5px; background-image: url('http://127.0.0.1:8000/site/img/logo-colored.png');">
                    </div>
