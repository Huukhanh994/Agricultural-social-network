...
Route::post('/fetchMessagesGroup', 'MessagesController@fetchMessagesGroup')->name('fetch.messages_groups');
...
Route::post('/makeSeenGroup', 'MessagesController@seenGroup')->name('messages.seenGroup');

/**
 * Get contacts
 */
Route::post('/getContacts', 'MessagesController@getContacts')->name('contacts.get');
Route::post('/getGroupContacts', 'MessagesController@getGroupContacts')->name('contacts.get_groups');
