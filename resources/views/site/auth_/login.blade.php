                        ...
                        <ul>
                            ...
                            <li class="shoping-cart more">
                                <a href="#" class="nav-link">
                                    ...
                                    <use xlink:href="{{asset('site/svg-icons/sprites/icons.svg#olymp-shopping-bag-icon')}}"></use>
                                    </svg>
                                    ...
                                    <ul>
                                        <li class="cart-product-item">
                                            ...
                                            <div class="more">
                                                ...
                                                <use xlink:href="{{asset('site/svg-icons/sprites/icons.svg#olymp-little-delete')}}">
                                                    </use>
                                                </svg>
                                            </div>
                                        </li>
                ...
                <div class="registration-login-form">
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#profile" role="tab">
                                ...
                                <use xlink:href="{{asset('site/svg-icons/sprites/icons.svg#olymp-register-icon')}}"></use>
                                </svg>
                            </a>
                        </li>
                    </ul>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="home" role="tabpanel" data-mh="log-tab">
                            ...
                            <form class="content" action="{{route('site.register.storeRegister')}}" method="POST">
                                @csrf
                                <div class="row">
                                    ...
                                    <div class="col col-12 col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                        ...
                                        <div class="form-group date-time-picker label-floating">
                                            ...
                                            <span class="input-group-addon">
                                                ...
                                                <use xlink:href="{{asset('site/svg-icons/sprites/icons.svg#olymp-calendar-icon')}}">
                                                    </use>
                                                </svg>
                                            </span>
                                        </div>
                                        ...
                                        <button type="submit" class="btn btn-purple btn-lg full-width">Register</button>
                                    </div>
                                </div>
                            </form>
                        </div>
                        ...
                        <div class="tab-pane" id="profile" role="tabpanel" data-mh="log-tab">
                            ...
                            <form class="content" method="POST" action="{{route('site.login.storeLogin')}}">
                                @csrf
                                <div class="row">
                                    <div class="col col-12 col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                        <div class="form-group label-floating">
