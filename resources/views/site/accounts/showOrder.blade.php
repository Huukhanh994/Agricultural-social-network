                    ...
                    <div class="col-md-12">
                        <div class="pull-left">
                            <address>
                                ...
                                <p class="text-muted m-l-5">College of Information & Communication Technology- Can Tho
                                    University,
                        ...
                        <div class="pull-right text-right">
                            <address>
                                ...
                                <p class="m-t-30"><b>Invoice Date :</b> <i class="fa fa-calendar"></i>
                                    {{\Carbon\Carbon::parse($order->created_at)->isoFormat('LLLL')}}</p>
                                <p><b>Due Date :</b> <i class="fa fa-calendar"></i>
                                    {{\Carbon\Carbon::parse($order->updated_at)->isoFormat('LLLL')}}</p>
                            </address>
                        </div>
                    </div>
                    <div class="col-md-12">
