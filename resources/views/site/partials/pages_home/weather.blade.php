    ...
    <div class="widget w-wethear">
        ...
        <div class="wethear-now inline-items">
            ...
            <svg class="olymp-weather-partly-sunny-icon">
                <use xlink:href="{{asset('site/svg-icons/sprites/icons-weather.svg#olymp-weather-partly-sunny-icon')}}">
                </use>
            </svg>
        </div>
        ...
        <ul class="weekly-forecast">
            ...
            <li>
                ...
                <svg class="olymp-weather-sunny-icon">
                    <use xlink:href="{{asset('site/svg-icons/sprites/icons-weather.svg#olymp-weather-sunny-icon')}}">
                    </use>
                </svg>
            ...
            <li>
                ...
                <svg class="olymp-weather-partly-sunny-icon">
                    <use
                        xlink:href="{{asset('site/svg-icons/sprites/icons-weather.svg#olymp-weather-partly-sunny-icon')}}">
                    </use>
                </svg>
            ...
            <li>
                ...
                <svg class="olymp-weather-cloudy-icon">
                    <use xlink:href="{{asset('site/svg-icons/sprites/icons-weather.svg#olymp-weather-cloudy-icon')}}">
                    </use>
                </svg>
            ...
            <li>
                ...
                <svg class="olymp-weather-rain-icon">
                    <use xlink:href="{{asset('site/svg-icons/sprites/icons-weather.svg#olymp-weather-rain-icon')}}">
                    </use>
                </svg>
            ...
            <li>
                ...
                <svg class="olymp-weather-storm-icon">
                    <use xlink:href="{{asset('site/svg-icons/sprites/icons-weather.svg#olymp-weather-storm-ico')}}n">
                    </use>
                </svg>
            ...
            <li>
                ...
                <svg class="olymp-weather-snow-icon">
                    <use xlink:href="{{asset('site/svg-icons/sprites/icons-weather.svg#olymp-weather-snow-icon')}}">
                    </use>
                </svg>
            ...
            <li>
                ...
                <svg class="olymp-weather-wind-icon-header">
                    <use
                        xlink:href="{{asset('site/svg-icons/sprites/icons-weather.svg#olymp-weather-wind-icon')}}-header">
                    </use>
                </svg>
