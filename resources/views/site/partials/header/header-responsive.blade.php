        ...
        <div class="tab-pane " id="request" role="tabpanel">
            ...
            <div class="mCustomScrollbar" data-mcs-theme="dark">
                ...
                <ul class="notification-list friend-requests">
                    ...
                    <li>
                        <div class="author-thumb">
                            <img src="{{asset('site/img/avatar56-sm.jpg')}}" alt="author">
                        </div>
                        <div class="notification-event">
                    ...
                    <li class="accepted">
                        <div class="author-thumb">
                            <img src="{{asset('site/img/avatar57-sm.jpg')}}" alt="author">
                        </div>
                        <div class="notification-event">
                    ...
                    <li>
                        <div class="author-thumb">
                            <img src="{{asset('site/img/avatar58-sm.jpg')}}" alt="author">
                        </div>
                        <div class="notification-event">
            ...
            <div class="mCustomScrollbar" data-mcs-theme="dark">
                ...
                <ul class="notification-list chat-message">
                    <li class="message-unread">
                        <div class="author-thumb">
                            <img src="{{asset('site/img/avatar59-sm.jpg')}}" alt="author">
                        </div>
                        <div class="notification-event">
                    ...
                    <li>
                        <div class="author-thumb">
                            <img src="{{asset('site/img/avatar60-sm.jpg')}}" alt="author">
                        </div>
                        <div class="notification-event">
                    ...
                    <li>
                        <div class="author-thumb">
                            <img src="{{asset('site/img/avatar61-sm.jpg')}}" alt="author">
                        </div>
                        <div class="notification-event">
                    ...
                    <li class="chat-group">
                        <div class="author-thumb">
                            <img src="{{asset('site/img/avatar11-sm.jpg')}}" alt="author">
                            <img src="{{asset('site/img/avatar12-sm.jpg')}}" alt="author">
                            <img src="{{asset('site/img/avatar13-sm.jpg')}}" alt="author">
        ...
        <div class="tab-pane " id="notification" role="tabpanel">
            ...
            <div class="mCustomScrollbar" data-mcs-theme="dark">
                ...
                <ul class="notification-list">
                    ...
                    <li class="un-read">
                        <div class="author-thumb">
                            <img src="{{asset('site/img/avatar63-sm.jpg')}}" alt="author">
                        </div>
                        <div class="notification-event">
                    ...
                    <li class="with-comment-photo">
                        <div class="author-thumb">
                            <img src="{{asset('site/img/avatar64-sm.jpg')}}" alt="author">
                        </div>
                        <div class="notification-event">
                        ...
                        <div class="comment-photo">
                            <img src="{{asset('site/img/comment-photo1.jpg')}}" alt="photo">
                    ...
                    <li>
                        <div class="author-thumb">
                            <img src="{{asset('site/img/avatar65-sm.jpg')}}" alt="author">
                        </div>
                        <div class="notification-event">
                    ...
                    <li>
                        <div class="author-thumb">
                            <img src="{{asset('site/img/avatar66-sm.jpg')}}" alt="author">
                        </div>
                        <div class="notification-event">
