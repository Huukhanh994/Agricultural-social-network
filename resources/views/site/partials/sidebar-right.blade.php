        ...
        <div class="mCustomScrollbar" data-mcs-theme="dark">
            ...
            <ul class="chat-users">
                <li class="inline-items js-chat-open">
                    ...
                    <div class="author-thumb">
                        <img alt="author" src="{{asset('site/img/avatar67-sm.jpg')}}" class="avatar">
                        ...
                        <ul class="more-icons">
                            ...
                            <li>
                                <svg data-toggle="tooltip" data-placement="top"
                                    ...
                                    <use xlink:href="{{asset('site/svg-icons/sprites/icons.svg#olymp-add-to-conversation-icon')}}">
                                    </use>
                                </svg>
                            </li>
                            ...
                            <li>
                                <svg data-toggle="tooltip" data-placement="top" data-original-title="BLOCK FROM CHAT"
                                    ...
                                    <use xlink:href="{{asset('site/svg-icons/sprites/icons.svg#olymp-block-from-chat-icon')}}"></use>
                                </svg>
                            </li>
                        </ul>
                ...
                <li class="inline-items js-chat-open">
                    ...
                    <div class="author-thumb">
                        <img alt="author" src="{{asset('site/img/avatar62-sm.jpg')}}" class="avatar">
                        <span class="icon-status online"></span>
                    </div>
            ...
            <ul class="chat-users">
                <li class="inline-items js-chat-open">
                    ...
                    <div class="author-thumb">
                        <img alt="author" src="{{asset('site/img/avatar64-sm.jpg')}}" class="avatar">
                        <span class="icon-status online"></span>
                    </div>
            ...
            <ul class="chat-users">
                <li class="inline-items js-chat-open">
                    ...
                    <div class="author-thumb">
                        <img alt="author" src="{{asset('site/img/avatar71-sm.jpg')}}" class="avatar">
                        <span class="icon-status online"></span>
                    </div>
                ...
                <li class="inline-items js-chat-open">
                    ...
                    <div class="author-thumb">
                        <img alt="author" src="{{asset('site/img/avatar72-sm.jpg')}}" class="avatar">
                ...
                <li class="inline-items js-chat-open">
                    ...
                    <div class="author-thumb">
                        <img alt="author" src="{{asset('site/img/avatar63-sm.jpg')}}" class="avatar">
