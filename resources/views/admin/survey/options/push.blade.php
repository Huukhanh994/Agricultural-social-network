...
<div class="container">
    <ol class="breadcrumb m-b-10">
        ...
        <li class="breadcrumb-item"><a href="{{route('admin.polls.index')}}">Index</a></li>
    ...
    <div class="well col-md-8 col-md-offset-2">
        ...
        @endif
        <form method="POST" action=" {{ route('admin.polls.options.add', $poll->id) }}">
            {{ csrf_field() }}
            <!-- Question Input -->
            ...
            <div class="form-group">
                <ul id="options">
                    <li>
                        <input type="text" name="options[0]" class="form-control add-input"
